-- ConCasa CRM — P2C-12 extender avanzar_etapa_operativa (transiciones 2→3 y 3→4)

-- =============================================================================
-- avanzar_etapa_operativa (transiciones 1→2, 2→3, 3→4 y 4→5)
-- =============================================================================
...
COMMENT ON FUNCTION public.avanzar_etapa_operativa(UUID, TEXT) IS
  'Mesa avanza expediente 1→2, 2→3, 3→4 o 4→5. Otras transiciones no permitidas.';
