-- ConCasa CRM — P2C-7 extender avanzar_etapa_operativa (transición 4→5)

-- =============================================================================
-- avanzar_etapa_operativa (transiciones 1→2 y 4→5)
-- =============================================================================
...
BEGIN
  ...
  -- P2C-7: no comparamos fecha_cita vs booking_date/time por riesgo de timezone;
  -- basta con fecha_cita + booking activo kind=biometricos status=booked.
...
COMMENT ON FUNCTION public.avanzar_etapa_operativa(UUID, TEXT) IS
  'Mesa avanza expediente 1→2 (integración) o 4→5 (biométricos agendados). Otras transiciones no permitidas.';
